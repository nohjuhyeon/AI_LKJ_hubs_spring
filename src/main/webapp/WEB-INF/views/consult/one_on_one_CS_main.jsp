                                                ...
                                                <HashMap<String, Object>>)
                                                    ...
                                                    for(HashMap<String, Object> Inquiry : InquiryList) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="collapsible" data-inquiry-id="<%= Inquiry.get("INQUIRY_ID") %>">
                                                                <%= (Inquiry.get("INQUIRY_TITLE") !=null) ? Inquiry.get("INQUIRY_TITLE").toString() : "" %>
                                                            </td>
                                                            <td>
                                                                <%= (Inquiry.get("INQUIRY_WRITER") !=null) ? Inquiry.get("INQUIRY_WRITER").toString() : "" %>
                                                            </td>
                                                            <td>
                                                                <%= (Inquiry.get("INQUIRY_DATETIME") !=null) ? Inquiry.get("INQUIRY_DATETIME").toString() : "" %>
                                                            </td>
                                                        </tr>
                                                        <!-- 내용을 숨기거나 보여줄 추가 행 -->
                                                        <tr style="display:none;" class="inquiry-content">
                                                            <td colspan="4">
                                                                <%= (Inquiry.get("INQUIRY_CONTENT") != null) ? Inquiry.get("INQUIRY_CONTENT").toString() : "" %>
                                                            </td>
                                                        </tr>
                                                        <tr>
