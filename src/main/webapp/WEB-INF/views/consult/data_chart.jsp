    ...
    <%@ taglib prefix="sec" uri="http://www.springframework.org/security/tags" %>
        ...
        <body>
            <%@ include file="/WEB-INF/views/templates/header.jsp" %>
                ...
                <h1 class="mt-5 mb-4 text-center">${selectedRegion} 데이터 현황 차트</h1>

                <nav class="navbar bg-body-tertiary" id="chart_nav">
                    <div class="container-fluid d-flex justify-content-center">
                        <form class="d-flex" role="search">
                            <select name="select_region" class="form-select me-2 text-center" aria-label="지역 선택"
                                style="width: 300px;">
                ...
                <div class="">
                    <table class="table table-striped table-sm">
                        <thead>
                            <tr>
                                <th style="width: 500px; text-align: center;">"아래에 제시된 데이터는 2020년 1월부터 2023년 12월까지의 평균
                                    값을 반영하고 있습니다."</th>
                            </tr>
                        </thead>
                        </tbody>
                ...
                <div class="row mb-2 ">
                    ...
                    <script>
                        ...
                        function drawChart() {
                            ...
                            //////////////////////////////////// 월별 관광 소비 추이 //////////////////////////////////
                            var dict_consume_transition = ${ listConsumeTransition };
                            ...
                            ////////////////////////////////////월별 키워드 검색량 //////////////////////////////////
                            var list_month_trend = ${ listMonthTrend };
