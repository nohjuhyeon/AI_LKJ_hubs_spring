...
<body>
    ...
    <div class="container" style="margin-top: 7px; margin-bottom: 7px;">
        <div class="row justify-content-start">
            <form class="col-3 position-fixed top-40 start-0 mb-3 ms-3 ml-3 bd-mode-toggl" style="top: 30%; width: 20%">
                <ul class="list-group">
                    <li class="list-group-item list-group-item-primary">마이페이지</li>
                    <div class="scrollable-box-list" style="height: 50%;">
                        <ul id="mypageList" class="list-group scrollarea">
                            <li class="list-group-item">
                                <button class="btn btn-light btn-block" formaction="/mypageInfo" method="">개인정보수정</button>
                            </li>
                            <li class="list-group-item">
                                <button class="btn btn-light btn-block" formaction="/mypageInsert_plan" method="">나의 여행계획 관리</button>
                            </li>
                            <li class="list-group-item">
                                <button class="btn btn-light btn-block" formaction="/mypageReview" method="">나의 여행 후기 관리</button>
                            </li>
                            <li class="list-group-item">
                                <button class="btn btn-light btn-block" formaction="/mypagePlan_list" method="">내가 찜한 여행기</button>
                            </li>
                            <li class="list-group-item">
                                <button class="btn btn-light btn-block" formaction="/mypageReserve_list" method="">예약내역</button>
                            </li>
                        </ul>
                    </div>
                </ul>
            ...
            <div class="col-8">
                <h2 class="mt-4" style="text-align: end;">나의 여행 후기 관리</h2>
                <form class="mb-4">
                    <div class="container">
